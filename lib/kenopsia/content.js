...
const SEEDS = {
  ...
  'q-and-a': {
    content: [
      '# Questions',
      '',
      'Anything about the server, the bots, the game or how something works. Ask here and someone will answer.',
      '',
      'Check whether it has already been asked before you post. Scrolling up is faster than waiting for a reply.',
      '',
      'This is for questions. If something needs the staff, use `/report` — that goes straight to them and nobody else sees it.',
    ].join('\n'),
  },
