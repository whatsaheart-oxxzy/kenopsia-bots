...
const SEEDS = {
  welcome: {
    ...
    content: [
      ...
      '',
      'Questions? Ask in support. Someone will answer.',
    ].join('\n'),
  },
  ...
  rules: {
    ...
    content: [
      ...
      '**8. Listen to the mods.** If a mod asks you to stop, stop. Argue about it later in support, not in the channel.',
  ...
  rewards: {
    ...
    content: [
      ...
      '',
      '**How to earn coins**',
      'Send a message: 2 coins, up to 100 a day',
  ...
  support: {
    content: [
      '# Support',
      '',
      'Something broken, something unclear, something unfair. Ask here.',
      '',
      'Write what happened and what you expected. Screenshots help more than descriptions.',
      '',
      'This is not the place to report a person. For that, type `/report` anywhere. Only staff sees it.',
    ].join('\n'),
  },
  ...
  'pet-guide': {
    ...
    content: [
      ...
      'Pets spend the wallet you fill by being active in the server. `/shop` lists what there is.',
      '',
  ...
  'voice-guide': {
    ...
    content: [
      ...
      '`/voice-shop` roles, an emoji slot, your own voice room · `/event` plan something and get paid for hosting it',
      '',
      'One honest note: Discord profile frames, avatar decorations and Nitro are not in the shop. No bot can hand those out, so nothing here pretends otherwise.',
    ].join('\n'),
  },
