...
const SEEDS = {
  ...
  'shop-guide': {
    content: [
      ...
      '',
      '**Your own voice room**',
      'A private voice room is 500 coins. You can rename it, move people in it, and choose how many people fit: `/inventory room limit:6` for six, `limit:0` for anyone. Run it again with a different number to change it.',
